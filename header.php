  ...
  <header>
          ...
          <div class="row gx-0 d-none d-lg-flex">
              ...
              <div class="col-lg-5 px-5 text-end">
                  <div class="h-100 d-inline-flex align-items-center py-3 me-4 ">
                      ...
                      <small class="fw-bold">+91 2222 000000</small>
                  </div>
                  <div class="h-100 d-inline-flex align-items-center">
                      ...
                      <a class="btn btn-sm-square bg-white text-primary me-1" href="https://twitter.com/tecnoinfor_/"><i class="bi bi-twitter"></i></a>
      ...
      <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 shadow">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
              ...
              ?>
              <a href="#" class="btn btn-primary py-4 px-lg-4 d-none d-lg-block">Download Grátis<i class="bi bi-arrow-right ms-3"></i></a>
          </div>
      </nav>
      <!-- Navbar End -->
  </header>
