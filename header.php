...
<body <?php body_class($extra_classes); ?> <?php if (is_front_page()): ?>data-bs-spy="scroll" data-bs-target="#goTop"
        data-bs-offset="0" <?php endif; ?>>
    <?php wp_body_open(); ?>
                        ...
                        <div class="h-100 d-inline-flex align-items-center">
                            <ul class="list-inline mb-0">
                                ...
                                foreach ($redes_sociais as $rede => $dados) {
                                    ...
                                    if (!empty($info['link'])) {
                                        printf(
                                            '<li class="list-inline-item"><a href="%s" class="btn btn-sm btn-outline-primary" target="_blank" rel="noopener noreferrer" aria-label="%s"><i class="%s" aria-hidden="true"></i></a></li>',
                                            esc_url($info['link']),
                                            esc_attr($info['nome']),
                                            esc_attr($info['icone'])
                                        );
                        ...
                        <div class="d-flex align-items-center ms-auto gap-2 py-3 py-lg-0">
                            ...
                            if ($whatsapp_clean):
                                ...
                                <a href="https://wa.me/<?php echo esc_attr($whatsapp_clean); ?>"
                                    class="btn btn-outline-success py-2 px-3 d-none d-lg-inline-flex align-items-center"
                                    target="_blank" rel="noopener noreferrer">
                                    <i class="bi bi-whatsapp me-2"></i> WhatsApp
                                </a>
                            <?php endif; ?>
                            <a href="<?php echo esc_url(home_url('/contato')); ?>"
                                class="btn btn-primary py-2 px-4 d-none d-lg-block">Fale Conosco<i
