    ...
    <section class="hero-home d-flex align-items-center wow fadeIn py-5 bg-primary-subtle min-vh-75 position-relative">
        <div class="container">
            <div id="softwareCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                <div
                    class="carousel-indicators software-indicators justify-content-start ms-0 ps-5 mb-4 d-none d-lg-flex">
                    <?php
                ...
                <div class="software-progress-container ms-5 mb-4 d-none d-lg-block"
                    style="width: 120px; height: 3px; background: rgba(0,0,0,0.1); border-radius: 2px; overflow: hidden;">
                    <div class="software-progress-bar bg-primary h-100" style="width: 0%; transition: width 5s linear;">
                    </div>
                </div>
                            ...
                            <div class="carousel-item <?php echo $is_first ? 'active' : ''; ?>">
                                <div class="row p-4 py-lg-5 align-items-center">
                                    <div class="col-lg-7 p-3 p-lg-5 pt-lg-3 text-center text-lg-start">
                                        ...
                                        <div
                                            class="d-flex align-items-center gap-2 mb-4 justify-content-center justify-content-lg-start">
                                            <span class="text-warning fw-bold fs-5">★★★★★</span>
                                            <span
                                                class="text-muted small"><strong>+<?php echo esc_html(get_theme_mod('tecnoinfor_clients', 125)); ?></strong>
                                                <?php _e('clientes satisfeitos em todo o Brasil', 'tecnoinfor'); ?></span>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <?php if ($download_link): ?>
                                                <a href="<?php echo esc_url($download_link); ?>"
                                                    class="btn btn-success btn-lg shadow-sm py-2 px-4 fw-bold rounded-pill"
                                                    target="_blank" rel="noopener noreferrer">Teste Grátis Agora</a>
                                            <?php endif; ?>
                                            <a href="<?php the_permalink(); ?>"
                                                class="btn btn-outline-primary btn-lg shadow-sm py-2 px-4 rounded-pill">Conheça
                                                mais</a>
                                        </div>
            ...
            <div class="row g-4 py-5 align-items-center">
                <div class="col-12 col-lg-6 col-xl-7">
                    <div class="about-text">
                        ...
                        <a href="<?php echo esc_url($site_url); ?>/quem-somos"
                            class="btn btn-lg btn-primary mt-4 shadow-sm px-4">
                            <small class="fw-bold"><?php echo __('Meet Tecnoinfor', 'tecnoinfor'); ?></small>
                        </a>
                    </div>
                </div>
                <div
                    class="col-12 col-lg-6 col-xl-5 d-flex justify-content-center flex-column ps-lg-5 border-start-desktop">
                        ...
                        <div class="col">
                            <div class="stat-item p-3 rounded bg-white shadow-sm h-100">
                                ...
                                <h3 class="fw-bold text-primary mb-0">
                                    +<span class="countup"
                                        data-count="<?php echo esc_attr(get_theme_mod('tecnoinfor_clients', 125)); ?>">0</span>
                                </h3>
                                <p class="text-muted small mb-2"><?php _e('Satisfied Clients', 'tecnoinfor'); ?></p>
                                <div class="stat-progress bg-primary"
                                    style="height: 4px; border-radius: 2px; width: 0; transition: width 1.5s ease-out; margin: 0 auto;">
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="stat-item p-3 rounded bg-white shadow-sm h-100">
                                ...
                                <h3 class="fw-bold text-success mb-0">
                                    +<span class="countup"
                                        data-count="<?php echo esc_attr(get_theme_mod('tecnoinfor_years', 15)); ?>">0</span>
                                </h3>
                                <p class="text-muted small mb-2"><?php _e('years of Experience', 'tecnoinfor'); ?></p>
                                <div class="stat-progress bg-success"
                                    style="height: 4px; border-radius: 2px; width: 0; transition: width 1.5s ease-out; margin: 0 auto;">
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="stat-item p-3 rounded bg-white shadow-sm h-100">
                                ...
                                <h3 class="fw-bold text-warning mb-0">
                                    +<span class="countup"
                                        data-count="<?php echo esc_attr(get_theme_mod('tecnoinfor_contracts', 21562)); ?>">0</span>
                                </h3>
                                <p class="text-muted small mb-2"><?php _e('Managed Contracts', 'tecnoinfor'); ?></p>
                                <div class="stat-progress bg-warning"
                                    style="height: 4px; border-radius: 2px; width: 0; transition: width 1.5s ease-out; margin: 0 auto;">
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                    <h3 class="display-6 fw-bold">
                        <?php _e('We help entrepreneurs simplify their businesses', 'tecnoinfor'); ?>
                    </h3>
                                                ...
                                                <figure>
                                                    ...
                                                    <figcaption>
                                                        ...
                                                        <p class="text-secondary fs-6 mb-0">
                                                            ...
                                                            <?php echo $empresa ? ', ' . esc_html($empresa) : ''; ?>
                                                        </p>
                                                    </figcaption>
                                                </figure>
                                            </div>
                    ...
                    while ($depoimentos->have_posts()):
                        ...
                        <div class="col">
                            <div class="card border-0 shadow-sm h-100 transition-hover"
                                style="border-top: 4px solid <?php echo $border_top_color; ?> !important;">
                                <div class="card-body text-center p-4">
                                    <img class="img-fluid rounded-circle mb-3 border border-3 border-primary" loading="lazy"
                                        src="<?php echo esc_url($imagem); ?>" alt="<?php echo esc_attr($cliente); ?>"
                                    ...
                                    <blockquote class="blockquote mb-3">
                                        ...
                                        <p class="text-muted small testimonial-text"
                                            data-full-text="<?php echo esc_attr(get_the_content()); ?>">
                                            <?php echo esc_html(wp_trim_words(get_the_content(), 25, '')); ?>
                                            <?php if (str_word_count(get_the_content()) > 25): ?>
                                                <span class="read-more text-primary fw-bold" role="button" tabindex="0">
                                                    <?php _e('Read more', 'tecnoinfor'); ?></span>
                                            <?php endif; ?>
                                        </p>
                                    </blockquote>
    ...
    <section class="faq wow fadeIn py-5">
        <div class="container my-5 px-4 px-lg-5">
            <div class="text-center mb-5">
                ...
                <p class="lead text-light-emphasis">Consulte a lista das perguntas mais frequentes ou entre em contato
                    conosco.</p>
            </div>
                            ...
                            <?php foreach ($left_faqs as $index => $faq):
                                ...
                                <div class="accordion-item rounded shadow-sm border-0 mb-3 bg-white">
                                    <h2 class="accordion-header" id="heading-left-<?php echo $post_id; ?>">
                                        <button class="accordion-button <?php echo $button_collapsed; ?> fw-bold text-dark py-3"
                                            type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse-left-<?php echo $post_id; ?>"
                                            aria-expanded="<?php echo $aria_expanded; ?>"
                                            aria-controls="collapse-left-<?php echo $post_id; ?>">
                                            <?php echo $title; ?>
                                        </button>
                                    </h2>
                                    <div id="collapse-left-<?php echo $post_id; ?>"
                                        class="accordion-collapse collapse <?php echo $show_class; ?>"
                                        aria-labelledby="heading-left-<?php echo $post_id; ?>"
                                        data-bs-parent="#accordionFaqsLeft">
                                ...
                                <div class="accordion-item rounded shadow-sm border-0 mb-3 bg-white">
                                    <h2 class="accordion-header" id="heading-right-<?php echo $post_id; ?>">
                                        <button class="accordion-button collapsed fw-bold text-dark py-3" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse-right-<?php echo $post_id; ?>"
                                            aria-expanded="false" aria-controls="collapse-right-<?php echo $post_id; ?>">
                                            <?php echo $title; ?>
                                        </button>
                                    </h2>
                                    <div id="collapse-right-<?php echo $post_id; ?>" class="accordion-collapse collapse"
                                        aria-labelledby="heading-right-<?php echo $post_id; ?>"
                                        data-bs-parent="#accordionFaqsRight">
                                        <div class="accordion-body text-muted pb-4"><?php echo $content; ?></div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
            ...
            <div class="text-center mt-5">
                <a href="<?php echo esc_url(home_url('/faq')); ?>" class="btn btn-outline-primary px-4 py-2 shadow-sm">
    ...
    <section class="cta text-center py-5 bg-gradient-cta position-relative overflow-hidden">
        <div class="container my-5 px-4 px-lg-5 position-relative z-index-1">
            ...
            <p class="lead text-white-50 mb-4">
                <?php printf(__('+%d clientes já usam. Comece agora gratuitamente, sem cartão de crédito.', 'tecnoinfor'), esc_html(get_theme_mod('tecnoinfor_clients', 125))); ?>
            </p>
            <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                <a href="<?php echo esc_url(home_url('/software')); ?>"
                    class="btn btn-success btn-lg py-3 px-5 fw-bold shadow-sm">
                    <?php _e('Experimente Grátis', 'tecnoinfor'); ?> <i class="bi bi-lightning-charge ms-2"></i>
                </a>
                <a href="https://wa.me/<?php echo esc_attr(preg_replace('/[^0-9]/', '', get_informacao_empresa('whatsapp'))); ?>"
                    class="btn btn-outline-light btn-lg py-3 px-5 shadow-sm" target="_blank" rel="noopener noreferrer">
    ...
    <section class="lastnews py-5">
        <div class="container my-5 px-4 px-lg-5">
                    ...
                    while ($noticias->have_posts()):
                            ...
                            <div class="col-12 col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="card h-100 border-0 shadow-sm flex-lg-row overflow-hidden transition-hover">
                                    <div class="col-lg-6 position-relative" style="min-height: 250px;">
                                        ...
                                        ?>
                                        <div
                                            class="position-absolute top-0 end-0 bg-primary text-white py-1 px-3 m-2 shadow-sm small fw-bold">
                                            <time
                                                datetime="<?php echo get_the_date('c'); ?>"><?php echo get_the_date('d M Y'); ?></time>
                                        </div>
                                        <div
                                            class="position-absolute top-0 start-0 bg-dark text-white py-1 px-3 m-2 opacity-75 small">
                                    ...
                                    <div class="col-lg-6 p-4 d-flex flex-column justify-content-between">
                                        <div>
                                            <span
                                                class="badge bg-warning text-dark mb-3 px-3"><?php _e('Destaque', 'tecnoinfor'); ?></span>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-auto">
                                            <span class="text-muted small"><i class="bi bi-clock me-1"></i>
                                                <?php printf(__('%d min de leitura', 'tecnoinfor'), $read_time); ?></span>
                                            <a href="<?php the_permalink(); ?>"
                                                class="btn btn-primary px-4"><?php echo __('read more', 'tecnoinfor'); ?>
                        ...
                        <?php else: ?>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 wow fadeInUp"
                                data-wow-delay="0.<?php echo esc_attr($current + 1); ?>s">
                                <div class="card h-100 border-0 shadow-sm transition-hover overflow-hidden">
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-between p-4">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-auto">
                                            <span class="text-muted small"><i class="bi bi-clock me-1"></i>
                                                <?php printf(__('%d min', 'tecnoinfor'), $read_time); ?></span>
                                            <a href="<?php the_permalink(); ?>"
                                                class="btn btn-primary px-3 py-1 btn-sm"><?php echo __('read more', 'tecnoinfor'); ?>
                                                <i class="bi bi-arrow-right ms-1"></i></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container text-center mt-5">
                <a href="<?php echo $site_url; ?>/blog" class="btn btn-outline-primary px-4 py-2"
